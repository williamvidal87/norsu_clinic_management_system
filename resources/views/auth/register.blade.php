    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="id_number" class="block w-full mt-1" type="text" name="id_number" :value="old('id_number')" required autofocus autocomplete="id_number" />
            </div>

            <div class="mt-4">
                <x-label for="dept_id" value="{{ __('College Department') }}" />
                <select id="dept_id"  class="block w-full mt-1" name="dept_id"  :value="old('dept_id')" required autofocus autocomplete="dept_id">
